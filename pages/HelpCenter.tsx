...
import { HelpCircle, FileText, MessageCircle, ExternalLink, Keyboard } from 'lucide-react';
    ...
    <div className="p-4 md:p-8 max-w-3xl mx-auto space-y-8 pb-32">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
           ...
           <p className="text-gray-500 text-sm">JiraMobileの利用方法やサポート情報</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow cursor-pointer group">
           ...
           <p className="text-xs text-gray-500 mb-4">機能の詳細や設定方法についての公式ドキュメントを参照します。</p>
           <span className="text-primary text-xs font-bold flex items-center gap-1">詳しく見る <ExternalLink size={12}/></span>
        </div>
        ...
        <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow cursor-pointer group">
           ...
           <h3 className="font-bold text-gray-800 mb-2">キーボードショートカット</h3>
           <p className="text-xs text-gray-500 mb-4">効率的に操作するためのショートカットキー一覧。</p>
           <span className="text-primary text-xs font-bold flex items-center gap-1">一覧を表示 <ExternalLink size={12}/></span>
        </div>
           ...
           <div className="flex gap-4 items-start">
              ...
              <div>
                 ...
                 <p className="text-xs text-gray-500 mb-4">
                   問題が発生した場合や機能のリクエストは、サポートチームまでご連絡ください。<br/>
                   通常24時間以内に返信いたします。
                 </p>
