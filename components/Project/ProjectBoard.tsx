...
const Column: React.FC<ColumnProps> = ({ title, status, issues, onIssueClick }) => {
  return (
    <div className="min-w-[280px] w-[85vw] md:w-[320px] flex flex-col h-full max-h-full bg-gray-100 rounded-lg mx-2 first:ml-4 last:mr-4">
      ...
      <div className="flex-1 overflow-y-auto p-2 space-y-2 no-scrollbar">
        ...
        <button className="w-full py-2 flex items-center justify-center text-gray-500 hover:bg-gray-200 rounded text-sm transition-colors">
...
export const ProjectBoard: React.FC<Props> = ({ issues, onIssueClick }) => {
