  ...
  return (
    <div className="bg-white border-b border-gray-200 h-14 flex items-center justify-between px-4 sticky top-0 z-30 shrink-0">
      <div className="flex items-center gap-3">
        ...
        <span
          onClick={() => navigate("/")}
          className="font-bold text-xl text-primary flex items-center gap-1 cursor-pointer"
        >
...
const AppContent = () => {
  ...
  useEffect(() => {
    ...
    const isAuthPage =
      location.pathname === "/welcome" || location.pathname === "/login";
        ...
        <Route element={<InitCheck />}>
          ...
          <Route element={<PrivateRoute />}>
            ...
            >
              <Route
                path="/"
                element={<Home onOpenIssue={setSelectedIssue} />}
              />
              ...
              <Route
                path="/search"
                element={<Search onOpenIssue={setSelectedIssue} />}
              />
