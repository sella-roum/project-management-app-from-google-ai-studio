          ...
          {step === 1 ? (
            <div className="text-center space-y-6 animate-fadeIn">
              ...
              <p className="text-gray-500">
                まずは、最初のチームプロジェクトを作成しましょう。名前とキーを入力してください。
              </p>
            ...
            <div className="text-center space-y-6 animate-fadeIn">
              ...
              <p className="text-gray-500">
                チームの働き方に合わせて、最適なテンプレートを選んでください。
              </p>
              <div className="grid grid-cols-1 gap-4">
                ...
                >
                  <div className="w-12 h-12 bg-white rounded-xl shadow flex items-center justify-center text-blue-500">
                    <Layout size={24} />
                  </div>
                ...
                >
                  <div className="w-12 h-12 bg-white rounded-xl shadow flex items-center justify-center text-green-500">
                    <ListTodo size={24} />
                  </div>
                  <div className="flex-1">
                    <div className="font-bold text-gray-800">
              ...
              <div className="flex gap-4">
                ...
                <button
                  ...
                  className="flex-1 p-4 bg-primary text-white rounded-2xl font-bold shadow-xl flex items-center justify-center gap-2"
                >
                  {loading ? "作成中..." : "開始する"}
                </button>
              </div>
