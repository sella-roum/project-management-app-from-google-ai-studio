import { DexieStorageAdapter, USERS } from "./dexieStorageAdapter";

export { DexieStorageAdapter, USERS };
...
export const toggleProjectStar = (id: string) => storage.toggleProjectStar(id);
...
export const createSprint = (projectId: string) =>
  storage.createSprint(projectId);
